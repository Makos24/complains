...
class PendingComplains extends Component
{
    use WithPagination;
    ...
    {
        $complains = Complain::search($this->search)->orderBy('created_at', 'desc')->where('status', 0)->paginate(20);
        return view('livewire.pending-complains', compact('complains'));
    }

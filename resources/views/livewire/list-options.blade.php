        ...
        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
            ...
            <div class="p-3">
                <table class="table-responsive w-full rounded">
                    <thead>
                        <tr>
                            <th class="border w-1/4 px-4 py-2">Service Option</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <a href="#" onclick="confirm('Are you sure?') || event.stopImmediatePropagation()" wire:click="destroy({{$option->id}})" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500">

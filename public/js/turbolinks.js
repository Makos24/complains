                    ...
                    for (r = "", t = e = 1; 36 >= e; t = ++e)
                        r +=
                            9 === t || 14 === t || 19 === t || 24 === t
                                ...
                                ? "4"
                                : 20 === t
                                ? (Math.floor(4 * Math.random()) + 8).toString(
                                      16
                                  )
                            ...
                            return (
                                ...
                                "function" ==
                                    typeof (t = this.delegate)
                                        .requestFinished && t.requestFinished(),
                                (this.delegate = null),
                                (this.xhr = null)
                            );
                        }),
            ...
            function() {
                ...
                e.BrowserAdapter = (function() {
                    ...
                    return (
                        ...
                        (n = i.NETWORK_FAILURE),
                        (o = i.TIMEOUT_FAILURE),
                        (r.prototype.visitProposedToLocationWithAction = function(
                            t,
                            e
                        ) {
                        ...
                        (r.prototype.visitRequestFailedWithStatusCode = function(
                            t,
                            e
                        ) {
                            switch (e) {
                ...
                e.History = (function() {
                    ...
                    return (
                        ...
                        (r.prototype.push = function(t, r) {
                            return (
                                (t = e.Location.wrap(t)),
                                this.update("push", t, r)
                            );
                        }),
                        (r.prototype.replace = function(t, r) {
                            return (
                                (t = e.Location.wrap(t)),
                                this.update("replace", t, r)
                            );
                        }),
                        ...
                        (r.prototype.update = function(t, e, r) {
                            ...
                            return (
                                (n = {
                                    turbolinks: { restorationIdentifier: r }
                                }),
                ...
                e.HeadDetails = (function() {
                    ...
                    return (
                        (t.fromHeadElement = function(t) {
                            var e;
                            return new this(
                                null != (e = null != t ? t.childNodes : void 0)
                                    ? e
                                    : []
                            );
                        }),
                        ...
                        (o = function(t) {
                            return (
                                "reload" ===
                                t.getAttribute("data-turbolinks-track")
                            );
                        }),
                        (r = function(t) {
                            var e;
                            return (
                                (e = t.tagName.toLowerCase()), "script" === e
                            );
                        }),
                        (n = function(t) {
                            var e;
                    ...
                    return (
                        ...
                        (t.prototype.getPermanentElementsPresentInSnapshot = function(
                            ...
                            for (
                                ...
                                (e = o[r]),
                                    t.getPermanentElementById(e.id) &&
                                        i.push(e);
                            return i;
                        }),
                        ...
                        (t.prototype.isVisitable = function() {
                            return (
                                "reload" !== this.getSetting("visit-control")
                            );
                        }),
                ...
                e.Renderer = (function() {
                    ...
                    return (
                        ...
                        (e.prototype.createScriptElement = function(t) {
                            var e;
                            return "false" ===
                                t.getAttribute("data-turbolinks-eval")
                                ? t
                        ...
                        (r = function(t, e) {
                            var r, n, o, i, s, a, u;
                            for (
                                i = e.attributes, a = [], r = 0, n = i.length;
                                n > r;
                                r++
                            )
                                (s = i[r]),
                    ...
                    return (
                        ...
                        (r.prototype.fail = function() {
                            ...
                            return "started" === this.state
                                ? ((this.state = "failed"),
                                  "function" ==
                                  typeof (t = this.adapter).visitFailed
                                      ? t.visitFailed(this)
                                      : void 0)
                                : void 0;
                        }),
                        ...
                        (r.prototype.requestCompletedWithResponse = function(
                            t,
                            r
                        ) {
                            return (
                                (this.response = t),
                                null != r &&
                                    (this.redirectedToLocation = e.Location.wrap(
                                        r
                                    )),
                                this.adapter.visitRequestCompleted(this)
                            );
                        }),
                        (r.prototype.requestFailedWithStatusCode = function(
                            t,
                            e
                        ) {
                            return (
            ...
            function() {
                ...
                e.Controller = (function() {
                    ...
                    return (
                        ...
                        (r.prototype.startVisitToLocationWithAction = function(
                            t,
                            r,
                            n
                        ) {
                            var o;
                            return e.supported
                                ? ((o = this.getRestorationDataForIdentifier(
                                      n
                                  )),
                        ...
                        (r.prototype.pushHistoryWithLocationAndRestorationIdentifier = function(
                            t,
                            r
                        ) {
                            return (
                        ...
                        (r.prototype.replaceHistoryWithLocationAndRestorationIdentifier = function(
                            t,
                            r
                        ) {
                            return (
                        ...
                        (r.prototype.historyPoppedToLocationWithRestorationIdentifier = function(
                            t,
                            r
                        ) {
                            var n;
                        ...
                        (r.prototype.scrollPositionChanged = function(t) {
                            var e;
                            return (
                                (e = this.getCurrentRestorationData()),
                                (e.scrollPosition = t)
                            );
                        }),
                        ...
                        (r.prototype.applicationAllowsFollowingLinkToLocation = function(
                            ...
                            var r;
                            return (
                                (r = this.notifyApplicationAfterClickingLinkToLocation(
                                    t,
                                    e
                                )),
                                !r.defaultPrevented
                        ...
                        (r.prototype.applicationAllowsVisitingLocation = function(
                            t
                        ) {
                            var e;
                            return (
                                (e = this.notifyApplicationBeforeVisitingLocation(
                                    t
                                )),
                                !e.defaultPrevented
                            );
                        }),
                        (r.prototype.notifyApplicationAfterClickingLinkToLocation = function(
                            t,
                            r
                        ) {
                        ...
                        (r.prototype.notifyApplicationAfterVisitingLocation = function(
                            t
                        ) {
                        ...
                        (r.prototype.notifyApplicationBeforeRender = function(
                            t
                        ) {
                        ...
                        (r.prototype.notifyApplicationAfterPageLoad = function(
                            t
                        ) {
                            return (
                                null == t && (t = {}),
                        ...
                        (r.prototype.getRestorationDataForIdentifier = function(
                            t
                        ) {
                            var e;
            ...
            function() {
                ...
                (e.start = function() {
                    ...
                    (t = function() {
                        ...
                        return (
                            (t = new e.Controller()),
                            (t.adapter = new e.BrowserAdapter(t)),
                            t
                        );
                    }),
                    (n = function() {

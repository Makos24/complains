        ...
        if (showAttr && showAttr.modifiers.includes("transition")) {
            ...
            attrs.length > 0
                ? (function(el, directives, showCallback) {
                      const enter = (
                              directives.find(i => "enter" === i.value) || {
                                  expression: ""
                              }
                          ).expression
                              .split(" ")
        ...
        if (showAttr && showAttr.modifiers.includes("transition")) {
            ...
            attrs.length > 0
                ? (function(el, directives, hideCallback) {
                      const leave = (
                              directives.find(i => "leave" === i.value) || {
                                  expression: ""
                              }
                          ).expression
                              .split(" ")
            ...
            stages = {
                start() {
                    transitionOpacity &&
                        ...
                        transitionScale &&
                            (el.style.transform = `scale(${styleValues.first
                                .scale / 100})`);
                },
                during() {
                    transitionScale &&
                        ...
                        (el.style.transitionProperty = [
                            ...
                            .join(" ")
                            .trim()),
                        (el.style.transitionDuration = `${styleValues.duration /
                            1e3}s`),
                ...
                show() {
                    ...
                    transitionOpacity &&
                        ...
                        transitionScale &&
                            (el.style.transform = `scale(${styleValues.second
                                .scale / 100})`);
                },
                hide() {
                    hook2();
    ...
    function handleForDirective(component, el, expression, initialUpdate) {
                    ...
                    for (var tmpCurrentEl = currentEl; tmpCurrentEl; ) {
                        ...
                        tmpCurrentEl =
                            !(
                                ...
                                void 0 ===
                                    tmpCurrentEl.nextElementSibling.__x_for_key
                            ) && tmpCurrentEl.nextElementSibling;
                    }
        ...
        for (
            ...
            transitionOut(nextElementFromOldLoop, () => {
                ...
                (nextElementFromOldLoop =
                    !(!nextSibling || void 0 === nextSibling.__x_for_key) &&
                    nextSibling);
        }
    }
        ...
        updateElements(rootEl, extraVars = () => {}) {
            for (
                this.walkAndSkipNestedComponents(
                    ...
                    el => {
                        if (
                            void 0 !== el.__x_for_key &&
                            !el.isSameNode(this.$el)
                        )
                            return !1;
                            ...
                            !(function(
                                ...
                                modifiers.includes("immediate")
                                    ...
                                    : (component.showDirectiveLastElement &&
                                          !component.showDirectiveLastElement.contains(
                                              el
                                          ) &&
                        ...
                        case "if":
                            ...
                            !(function(el, expressionResult, initialUpdate) {
                                ...
                                const elementHasAlreadyBeenAdded =
                                    ...
                                    !0 ===
                                        el.nextElementSibling.__x_inserted_me;
                                if (
                                    expressionResult &&
